...
extern "C" bool add_iomem_region( const void* start, const void* end, const char* description ) ;
...
BOOST_AUTO_TEST_CASE( test_iomem_add ) {
   ...
   BOOST_CHECK( add_iomem_region( 0, (void*) MAX_PHYS_ADDR, "replaced - all") ) ;
   BOOST_CHECK( validate_iomem() ) ;
   ...
   BOOST_CHECK( add_iomem_region( (void*) 0x000, (void*) 0x0FF, "region 0 - new") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x100, (void*) 0x1FF, "region 1 - new") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x200, (void*) 0x2FF, "region 2 - new") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x300, (void*) 0x3FF, "region 3 - new") ) ;

   BOOST_CHECK( add_iomem_region( (void*) 0x000, (void*) 0x0FF, "region 0") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x100, (void*) 0x1FF, "region 1") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x200, (void*) 0x2FF, "region 2") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x300, (void*) 0x3FF, "region 3") ) ;

   BOOST_CHECK( add_iomem_region( (void*) 0x060, (void*) 0x0AF, "region 0 - inside") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x160, (void*) 0x1AF, "region 1 - inside") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x260, (void*) 0x2AF, "region 2 - inside") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x360, (void*) 0x3AF, "region 3 - inside") ) ;

   BOOST_CHECK( add_iomem_region( (void*) 0x000, (void*) 0x02F, "region 0 - left") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x100, (void*) 0x12F, "region 1 - left") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x200, (void*) 0x22F, "region 2 - left") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x300, (void*) 0x32F, "region 3 - left") ) ;

   BOOST_CHECK( add_iomem_region( (void*) 0x0D0, (void*) 0x0FF, "region 0 - right") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x1D0, (void*) 0x1FF, "region 1 - right") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x2D0, (void*) 0x2FF, "region 2 - right") ) ;
   BOOST_CHECK( add_iomem_region( (void*) 0x3D0, (void*) 0x3FF, "region 3 - right") ) ;
...
BOOST_AUTO_TEST_CASE( test_iomem_add_bad ) {
   BOOST_CHECK( validate_iomem() ) ;
   BOOST_CHECK( !add_iomem_region( (void*) 0x000, (void*) 0x000, "test" ) ) ;
   BOOST_CHECK( !add_iomem_region( (void*) 0x001, (void*) 0x000, "test" ) ) ;
   BOOST_CHECK( !add_iomem_region( (void*) 0x000, (void*) 0x001, NULL ) ) ;
   BOOST_CHECK( !add_iomem_region( (void*) 0x000, (void*) 0x001, "" ) ) ;
...
BOOST_AUTO_TEST_CASE( test_iomem_add_overlap ) {
   ...
   BOOST_CHECK( !add_iomem_region( (void*) 0x000, (void*) 0x100, "overlap 1 - bad") ) ;
   BOOST_CHECK( !add_iomem_region( (void*) 0x0FF, (void*) 0x101, "overlap 2 - bad") ) ;
